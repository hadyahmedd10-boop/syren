...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    description: "A complete Nile cruise from Luxor to Aswan aboard a 5-star cruise ship — temples, tombs, desert evenings, and the timeless rhythm of the river.",
    introduction: "The Nile has been the heartbeat of Egypt for thousands of years. This five-day cruise carries you from the temples of Luxor southward through ancient landscapes to the serene city of Aswan — each stop revealing a new chapter of one of the world's greatest civilizations. A Syren representative welcomes you at arrival and remains with you until the final farewell, ensuring every detail is handled with care.",
    ...
    highlights: [
      ...
      "Philae Temple set on an island in the Nile at Aswan",
      "Authentic Galabeya Party and Nubian evening onboard",
    ],
    included: [
      "Syren welcome and private escort upon arrival in Luxor",
      "4 nights full board on a 5-star Nile cruise ship",
      "All meals as specified in the daily itinerary",
      "Guided excursions at all ports of call",
      "Admission tickets for all sites mentioned",
